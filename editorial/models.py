...
class Role(models.Model):
    """Un rôle métier : correspondant, rédacteur, correcteur, responsable, commercial ou diffuseur."""
...
class Depeche(models.Model):
    ...
    chapo = models.CharField(max_length=500, blank=True, help_text="Résumé rapide")
    contenu = models.TextField()
    categorie = models.ForeignKey(Categorie, on_delete=models.SET_NULL, null=True)
    auteur = models.ForeignKey(Utilisateur, on_delete=models.PROTECT)
    statut = models.CharField(max_length=20, choices=STATUTS, default=BROUILLON)
    note_rejet = models.TextField(blank=True, help_text="Motif de rejet")
...
class Historique(models.Model):
    ...
    depeche = models.ForeignKey(Depeche, on_delete=models.CASCADE)
